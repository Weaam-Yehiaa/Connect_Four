...
bool check_win(){
    ...
    for(int i=0;i<N-3;++i)
    {
        ...
        while(j<M&&x<N)
        {
            ...
            if(v.size()>=6)
            {
                if((v[2]=='X'&&v[3]=='X'&&v[4]=='X'&&v[5]=='X')||(v[2]=='O'&&v[3]=='O'&&v[4]=='O'&&v[5]=='O'))
                    return true;
            }
            else if(v.size()>=5)
            {
                if((v[2]=='X'&&v[3]=='X'&&v[4]=='X'&&v[1]=='X')||(v[2]=='O'&&v[3]=='O'&&v[4]=='O'&&v[1]=='O'))
                    return true;
            }
            else if(v.size()>=4)
            {
                if((v[2]=='X'&&v[3]=='X'&&v[0]=='X'&&v[1]=='X')||(v[2]=='O'&&v[3]=='O'&&v[0]=='O'&&v[1]=='O'))
                    return true;
            }
        }
         v.clear();
